...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand btn btn-default" href="{{ url('/') }}">
                    TestVN
                </a>

                <a class="navbar-brand btn btn-info" href="{{ url('questions') }}">
                    Question Bank
                </a>

                <a class="navbar-brand btn btn-info" href="{{ url('tests') }}">
                    Test Bank
                </a>

                <a class="navbar-brand btn btn-info" href="{{ url('exam/list') }}">
                    Test List
                </a>
